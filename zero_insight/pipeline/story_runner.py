...
from zero_insight.image.prompt_builder import build_image_prompt, build_prompt_package
    ...
    try:
        ...
        for slide in slides:
            ...
            if ai_image_provider:
                prompt = build_image_prompt(brief, slide, brand_profile)
                try:
                    ai_image_provider.generate_image(prompt, 1024, 1536, base_path)
